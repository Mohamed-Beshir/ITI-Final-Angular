...
export class AddPropertyService {
  ...
  searchProperties(city: string, district: string, propertyType: string, status : string | null, area : string, beds : string, baths : string, price : string, period : string | null){

...
@Component({
  ...
  styleUrl: './properties-rent.component.css'
})
export class PropertiesRentComponent {
a1="";
umbrela=faUmbrella;
home=faHome;
arrow=faAngleRight;
...
fetchDataFromApi() {
  this.apiService.getAllPropertyRentOrSale('for_rent').subscribe((data) => {
    this.data = data;
  });
}
...
sort (order_by : string) {
  this.apiService.getAllPropertyRentOrSaleOrderBy('for_rent', order_by)
      .subscribe(data => {
        this.data = data;
  })
}
